    ...
    <>
      <header className="header-top-strip py-1">
        <div className="container-xxl">
          <div className="row">
            <div className="col-6">
              <p className="text-white mb-0">Shopping with with your syle</p>
            </div>
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Contact By Hotline: 0933546078
              </p>
            </div>
          </div>
        </div>
      ...
      <header className="header-upper py-1">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-2">
              <h2>
                <Link className="text-white">DevShop.</Link>
              </h2>
            </div>
            <div className="col-5">
                ...
                <div>
                  <div class="dropdown">
                    ...
                    >
                      ...
                      <span className="me-5">Categories</span>
                    </button>
                    <ul
